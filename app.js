...
function openScanner() {
  ...
  scanner.start(
    ...
    modalRoot.querySelector("#reader").innerHTML =
      `<div class="empty">Impossibile accedere alla fotocamera.<br>${escapeHtml(String(e))}<br><br>Puoi comunque scrivere il codice qui sotto.</div>`;
  });
}
